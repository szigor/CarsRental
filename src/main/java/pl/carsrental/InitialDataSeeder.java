...
public class InitialDataSeeder implements Runnable{
    ...
    public void run() {
        ...
        Car car1 = carRepository.save(Car.builder()
                .make("Audi")
                .model("A8")
                .src("https://pictures.trader.pl/eurotax/pictures/b/27/40fb94442b9c29711afc17322e497cf0.jpg")
                .horsePower(350)
                .capacity(4.134)
        ...
        Car car4 = carRepository.save(Car.builder()
                .make("Nissan")
                .model("GT-R")
                .src("https://i.wpimg.pl/1920x0/m.autokult.pl/nissan-gt-r-t-spec-1-963766bb39f.jpg")
                .horsePower(565)
                .capacity(3.799)
        ...
        Car car5 = carRepository.save(Car.builder()
                .make("Tesla")
                .model("Model 3")
                .src("https://fleetmagazine.pt/wp-content/uploads/2021/12/IMG_20210907_154849-scaled-e1638791714509.jpg")
                .horsePower(497)
